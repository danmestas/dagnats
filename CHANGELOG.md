...
- Dependency bumps: `nats-server` and `mcp-go`.
...
- **`dagnats status` rendered a grouped consumer's task type with the
  group sentinel attached** (e.g. `greet.=fast` instead of `greet`), for
